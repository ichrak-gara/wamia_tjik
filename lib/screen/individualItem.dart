  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Cake au Chocolate", style: TextStyle(color: Colors.black, fontSize: 18),),
        leading: IconButton(
                                                          ...
                                                          child: ElevatedButton(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                MainAxisAlignment
                                                                    .center,
                                                                children: [
                                                                  Image.asset("assets/images/add_to_cart.png"
                                                                  ),
                                                                  Text(
                                                                    "Add to Cart",
                                                                  )
                                              ...
                                              Padding(
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Image.asset("assets/images/cart_filled.png"
                                                    ),
                                                  ),
                                                ),
                                              ),
