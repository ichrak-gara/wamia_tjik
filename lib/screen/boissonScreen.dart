...
class BoissonScreen extends StatelessWidget {
  static const routeName ='/boissonScreen';

  const BoissonScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Boissons", style: TextStyle(color: Colors.black, fontSize: 18),),
        leading: IconButton(
